    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">เอาค่าปรับ / ค่าติดตามออก</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('/') }}">home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">เอาค่าปรับ / ค่าติดตามออก
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid main-content">
                ...
                <img src="{{ asset('images/PAYCOLLECT_PENALT.png') }}" class="img-fluid mb-4" alt="...">
                ...
                list_cus.forEach((set_obj) => {
                    list_contract.push({
                        Contract_number: set_obj['Contract No.']
                            ...
                            .replace(/[~`!@#$%^&*()+={}\[\];:\'\"<>.,\/\\\?-_]/g, '')
                            .trim(),
                        Install: Object.values(set_obj)[2],
                        Penalty: Object.values(set_obj)[3],
                        Paycollect: Object.values(set_obj)[4],
                    })
                })
